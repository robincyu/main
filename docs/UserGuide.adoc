...
=== [Coming in version 2.0] Selecting a person : `select`
...
=== [Coming in version 2.0] Listing entered commands : `history`
...
// tag::undoredo[]
=== [Coming in version 2.0] Undoing previous command : `undo`
...
=== [Coming in version 2.0] Redoing the previously undone command : `redo`
