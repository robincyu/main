...
public class EditCommandSystemTest extends CardCollectionSystemTest {
    ...
    public void edit() {
        ...
        assertTrue(getModel().getCardCollection().getPersonList().contains(BOB));
        ...
        /* Case: filtered person list, edit index within bounds of card collection and person list -> edited */
        ...
        /* Case: filtered person list, edit index within bounds of card collection but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
