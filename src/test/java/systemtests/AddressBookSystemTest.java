...
public abstract class AddressBookSystemTest {
    ...
    protected void showAllPersons() {
        ...
        assertEquals(getModel().getAddressBook().getCardList().size(), getModel().getFilteredPersonList().size());
    }
    ...
    protected void showPersonsWithName(String keyword) {
        ...
        assertTrue(getModel().getFilteredPersonList().size() < getModel().getAddressBook().getCardList().size());
    }
    ...
    protected void assertSelectedCardUnchanged() {
        ...
        assertFalse(getPersonListPanel().isSelectedCardCardChanged());
    }
