...
public class AddCommandSystemTest extends CardCollectionSystemTest {
    ...
    public void add() {
        ...
        /* Case: add a person with all fields same as another person in the card collection except name -> added */
        toAdd = new PersonBuilder(AMY).withName(VALID_NAME_BOB).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
            + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);

        /* Case: add a person with all fields same as another person in the card collection except phone and email
         * -> added
         */
