...
public class LogicManagerTest {
     ...
     */
    private static class JsonCardCollectionIoExceptionThrowingStub extends JsonCardCollectionStorage {
        private JsonCardCollectionIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
