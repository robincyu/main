 ...
 * A flashcard is considered unique by comparing using {@code Flashcard#isSameFlashcard(Flashcard)}. As such, adding
 * and updating of flashcards uses Flashcard#isSameFlashcard(Flashcard) for equality so as to ensure that the flashcard
 * being added or updated is unique in terms of identity in the UniqueFlashcardList. However, the removal of a flashcard
 * uses Flashcard#equals(Object) so as to ensure that the flashcard with exactly the same fields will be removed.
 * <p>
