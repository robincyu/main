...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setCardCollectionFilePath(newUserPrefs.getCardCollectionFilePath());
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, cardCollectionFilePath);
    }
